...
D'une manière générale, :ldquo:La Fortune des Rougon:rdquo: est le roman d'ouverture qui annonce les principaux personnages de la suite ; et ''Le Docteur Pascal'' en est le bilan final.
